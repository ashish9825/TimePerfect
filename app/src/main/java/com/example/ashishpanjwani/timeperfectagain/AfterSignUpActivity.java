...
public class AfterSignUpActivity extends AppCompatActivity implements InternetConnectivityListener, NavigationView.OnNavigationItemSelectedListener,
    ...
    int semNo= Integer.parseInt(SelectActivity.getSemNumber());
    String branchName;
    String collegeName;
    String sectionOfBranch;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        header.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(AfterSignUpActivity.this,ProfileActivity.class);
    ...
    private void getDayTimes() {
        ...
        if (SelectActivity.getSectionName() == null) {
            sectionOfBranch="";
        } else {
            sectionOfBranch = SelectActivity.getSectionName().toString();
        }
        branchName=SelectActivity.getBranchName() + sectionOfBranch;
        collegeName= SelectActivity.getCollegeName().toString();
        Log.d("Branch",branchName);

        Call<List<UserProfile>> call = TimePerfectAPIs.getCurrentTimeTable().registerUser(mEmail,mUsername,collegeName,branchName,semNo);
        ...
        call.enqueue(new Callback<List<UserProfile>>() {
                ...
                timeCall.enqueue(new Callback<List<CurrentTimeList>>() {
                    ...
                    public void onResponse(Call<List<CurrentTimeList>> call, Response<List<CurrentTimeList>> response) {
                        ...
                        if (currentTimeList.size() == 0) {
                            ...
                            recyclerView.setLayoutManager(new LinearLayoutManager(AfterSignUpActivity.this));
                            frontScreenAdapter = new FrontScreenAdapter(AfterSignUpActivity.this, currentTimeList);
                    ...
                    public void onFailure(Call<List<CurrentTimeList>> call, Throwable t) {
                        ...
                        Toast.makeText(AfterSignUpActivity.this, "Connection Failure !", Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onFailure(Call<List<UserProfile>> call, Throwable t) {
                ...
                Toast.makeText(AfterSignUpActivity.this, "Network TimeOut !", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void getWithEmail() {
        ...
        call.enqueue(new Callback<List<UserProfile>>() {
            ...
            public void onResponse(Call<List<UserProfile>> call, Response<List<UserProfile>> response) {
                ...
                timeCall.enqueue(new Callback<List<CurrentTimeList>>() {
                    ...
                    public void onFailure(Call<List<CurrentTimeList>> call, Throwable t) {
                        ...
                        Toast.makeText(AfterSignUpActivity.this, "Ashish !", Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onFailure(Call<List<UserProfile>> call, Throwable t) {
                ...
                Toast.makeText(AfterSignUpActivity.this, "MainActivity !", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id==R.id.nav_time) {
            Intent intent = new Intent(AfterSignUpActivity.this,DayActivitty.class);
            intent.putExtra("UniqueId","From AlreadySignUpActivity");
            startActivity(intent);
            overridePendingTransition(android.R.anim.fade_in,android.R.anim.fade_out);
        } else if (id==R.id.nav_donate) {
            Intent intent = new Intent(AfterSignUpActivity.this, DonateActivity.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
            startActivity(intent);
            overridePendingTransition(android.R.anim.fade_in,android.R.anim.fade_out);
            finish();
        } else if (id==R.id.nav_about) {
            Intent intent = new Intent(AfterSignUpActivity.this, AboutActivity.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
            startActivity(intent);
            overridePendingTransition(android.R.anim.fade_in,android.R.anim.fade_out);
            finish();
